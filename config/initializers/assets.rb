...
F2POSRSRanks::Application.configure do
   ...
   config.false_p2p_flagged = ["bigstickmann", "PEllingsen", "anggang2", "orangec", "netbook pro", "QuellaXtreme", "Freckled Dad", "Teace", "F2PUIM Nugs", "NugsandHugss", "Lufteufel", "Lowsmiuthy", "Lody f2p", "emilioboltin", "HC Gamer69", "EarthTally16", "30 99 30", "SQWEEZY", "Obor", "Andi027", "BOOKLET", "Aneu F2P", "Disziple", "LazyWalrus", "Pawz", "ColdFingers3", "Anne Shirley", "WeirdWiteCYA", "DJ9", "CraftyHeng", "Tyrone P", "Janne Ahonen", "Powzor", "Jambo3547", "Obbitt", "Nusitra2", "Please Thx", "becca waifu", "UltIronDream", "St Coin", "HelplessBob", "Fail To Pay", "iron snipa5", "KonnorFriend", "Under X", "runite inc", "rosco133", "NewInvestor", "HC Piers", "Frosty Boy20", "I OMNI I", "Affalterbach", "edijs t", "Hogflymask", "iron 2h life", "7immye", "kaaketti", "Limit Limits", "null iron", "I i_E_i I", "496d41426f74", "Sun Montage", "wakeyaaron", "Jrjs2", "whatsmean", "venerant sol", "Tomm_BR", "Flowe Rs", "fed0ra", "PrumJammed", "yasssqueen66", "antihero-99", "10 HP NBB", "Frisk En", "suckonthis4", "Frogmask", "black cane", "iron necrond", "Yelsos", "UIM dreamz", "PeteyMcFly", "Vegan Crime", "icdat iron", "muhprivacy", "hc 9", "bmrgould1", "baby head 2", "minlvlskilla", "tannerdino", "kelarotta1", "5OknZqE9j", "Iron Grae", "Terrathrone", "mr ebola man", "ironyuck", "HMS ASSHAT", "Hey Dougie", "therushof it", "Norm Scully", "Iron figar", "wdscrazy99", "yuumers", "Gandalf Rolf", "F 2 P IM", "unlikely mau", "u and i man", "f2p 60c", "ikson", "pieceful one", "Rune 2h sell", "Sylvester910", "f2pspicelord", "hc blvq", "Special Greg", "Dikke b33r", "DLSquirrel", "Fe elession", "Oppai suki", "Ultihardiron", "Laskati", "5ent", "seid", "BlueCap_BC", "Emo HCIM", "f2pMobIron", "Cas F2P", "Rich is Gey", "IM_WikiDic", "Quthalos", "Z3R0 D3ATHS", "Arosial", "BigFootTall", "LingonBerget", "trollare3", "wassaupmaen", "Mo Arabs", "UIM F2P AFK", "Fe2p Clues", "F2P Purki", "ChaoticalF2P", "Artictwo", "Other Sackmo", "HardC FE Man", "Alxsk911", "Helligegeit", "HC F2P cx", "Buy 1 Pot", "Tru and Blu", "NotBotButAlt", "Burnyoureyes", "despair trap", "gerben duck", "Rootman89", "oooosonasty", "Dabs R Nice", "Goo Goo", "Zanshi UIM", "Schism22", "2Skeles1Worm", "omega primus", "Leone Wild", "Kiddo Slice", "jiachang", "S K E N G", "Unto Himself", "8copper69", "uim rhys", "Spartan born", "Zeemics", "VAE VlCTlS", "zl00", "earth7", "aMiniMan", "zombobvc", "OSAAT in F2P", "Meigryn", "8slayfortgo", "jei Kristjan", "jul3ske", "iZbo", "lil maresh", "apple zauce", "uim chummy", "akryia", "UIMBunyan", "Beige Iron", "Ironz 0g", "plzzfreebond", "D3athVsiron", "UwU xP", "ironicated", "Varrock earl", "KISS MY EGO", "Shiesty Arch", "friendo btw", "GB Packerz", "woofs f2p", "andi027", "jewgarthe3rd", "wil woody", "Crownaldo", "Sea trout", "F2P BENJY", "UIM SWAI", "Hc freund", "F2P Bino", "abyss pouch", "rozwala", "The fixr", "teddyfeaces", "sirreyalisum", "Salty Brad", "Zalnox", "Draken Feest", "1_null", "daring goat", "Benny Hc Im", "Mobile f2per", "um im an uim", "multii3ill", "LG Brandon", "z zzz zz", "utopiaxd", "f2pKong", "sharpcow2461", "glrdhcim", "charizard IM", "uim no pay", "UIM Tmet", "estonian im", "a holy iron", "Raccoon boss", "playground g", "xoxo meep", "spookyrake", "vitaminas e", "basilk1678", "bigironchuby", "third sight", "Hukkawee", "Cosmicflip", "jp skill", "Lee Jobber", "Pemu", "deadoldcat", "2A the Doge", "tom o91", "Chuchulaura", "Iron Wunga", "Lootandboot2", "shiny type", "Exetlai0s", "grunt989172", "jmd992", "pked yo m0m", "Juudanakke", "faustbear", "dave uim", "thesilvervio", "funky padme", "DewCookies", "bbrims20", "time sunk", "ctbel", "OWOOOOWWWWW", "clappindash", "m enace", "precious uim", "uiw fyrerose", "HCIM MGS2", "Marthyrr IM", "straccit", "F2P toot", "benspotato", "Tiran004", "Griefking23", "Mr Moisted", "e z z", "lara crooft", "FleeTwoPray", "cristoncmost", "Akikstone717", "Uim elvis", "F2P Law Rune", "Iron Kikyo", "hcim tris", "Puparium", "Tukohr", "55zx", "Tuurible", "Masennukseni", "np20", "Stinky Dane", "fashion rat", "PvP SUCKS HC", "RaianRS", "UIM MrStark", "Earls fat", "don ressler", "fug ddd", "Lionhaired", "F2P Chin", "Doctor Blast", "ftp gigachad", "yipne", "Matkapuhelin", "free bontho", "F2P Serdra", "dreary grind", "Dame Jacinta", "Lord Beeeef", "Uim0b1le", "Gengar ult", "uim edit", "Yugen Zen", "NO LlFER", "Hc just eat", "1sttryhcim", "Mr Free Iron", "Tanky monk", "Bettykurps", "Imazuna", "SrJoaum", "dr cbd", "NetWaps", "T erran", "FreestFe", "frog goose", "Fanfare 2", "Lord here", "Sildra 42", "Filthy briq", "Cowedtoohard", "giron timmeh", "joseph torok", "Jern Legende", "Ambar 7", "Sznitu", "itsMoxMox", "Alkali bee", "Samgieswag", "ilovepie2007", "F2P Mr Manne", "Ringus man", "Fylke sam", "Pekko", "Rhett f2p", "Fichtls lied", "diceminecash", "kubectl get", "alheli cel", "UDiablo", "F2p im Bored", "theredkoda", "Ult boi", "bjornlarsson", "friar chang", "uim beats", "all irony", "nolife dead", "bubbl3 b0y", "wolfram f2p", "colormefree", "F2p himmel", "uohhhh seggs", "Letraw", "Glu slu", "W385 viking", "bread1959", "Ask Brandon", "quest doeser", "Willow Book", "lobben9", "I have boob", "TEACEANDWAR", "Kitty pspsps", "beefsausages", "Ameeba69", "mellomkjott", "FTP clueman", "Skill only", "liver pain", "ju n0", "Thanks Pain", "Notfrozen299", "Mapletonian", "ClueScrolls0", "Jman Here", "Free Chompz", "Hc sand rat", "Sithkegg", "th3 godson", "Limited Sack", "Step Skiller", "F2P Apple", "iEXP slayer", "Sur Lam Nia", "ramen au", "actualhorn", "Feraien", "the shizuka", "RF Scott", "jecan", "lymbicsystem", "FlippinMyDog", "F Byden", "C 02", "b wick", "baldromeo", "raw dairy", "Maze dweller", "Bluten9471", "7h", "UIM iodiin", "Lillie756", "kidsula", "uim f2p 807", "iponderorbs"]
   ...
   # Purpose: Temporarily reroute add player functionality to also add to false flagged P2P list
   # Set to true to enable automatic flagging of new players as F2P (bypasses P2P flag)
   # IMPORTANT: P2P experience checks and boss KC checks will STILL execute normally
   # To revert: Simply set this to false and restart the application
   # NOTE: Runtime-flagged players are stored in memory only, not persisted to this config file
   config.auto_add_to_false_p2p_flagged = false
   
   # Runtime storage for newly flagged players (persists only during app lifetime)
   # These players will be merged with downcase_false_p2p_flagged for F2P filtering
