...
F2POSRSRanks::Application.configure do
   ...
   # Players incorrectly flagged as P2P by the detection system (temporary until automatic solution)
    # NOTE: Players with total level > 1494 (F2P max = 15×99 + 9×1) should be removed from this list
    # as they have trained P2P skills. Use: rake players:check_false_p2p_flagged to identify such players.
   config.false_p2p_flagged = ["Andi027", "BOOKLET", "Aneu F2P", "Disziple", "LazyWalrus", "Pawz", "Patriot", "ColdFingers3", "Anne Shirley", "WeirdWiteCYA", "DJ9", "CraftyHeng", "Tyrone P", "Janne Ahonen", "Powzor", "Jambo3547", "Obbitt", "Nusitra2", "spaldaddy", "Please Thx", "becca waifu", "UltIronDream", "St Coin", "HelplessBob", "cris4O8", "Figo 7 0 6", "Brickypuff", "Fail To Pay", "iron snipa5", "KonnorFriend", "Under X", "runite inc", "rosco133", "I R R3v3ng3", "NewInvestor", "HC Piers", "893Schein174", "Frosty Boy20", "King Tim I", "OSArPaSikari", "I OMNI I", "Affalterbach", "edijs t", "Kunoscape", "georgemonger", "Hogflymask", "Top 1 player", "iron 2h life", "7immye", "Vicktor0_IM", "kaaketti", "Limit Limits", "null iron", "I i_E_i I", "Bixeon", "496d41426f74", "Sun Montage", "wakeyaaron", "Jrjs2", "whatsmean", "venerant sol", "Tomm_BR", "Flowe Rs", "fed0ra", "PrumJammed", "yasssqueen66", "antihero-99", "Maze", "10 HP NBB", "Frisk En", "suckonthis4", "Frogmask", "sir lay alot", "black cane", "iron necrond", "Yelsos", "UIM dreamz", "PeteyMcFly", "Vegan Crime", "icdat iron", "brewUIM", "muhprivacy", "hc 9", "bmrgould1", "baby head 2", "minlvlskilla", "tannerdino", "kelarotta1", "5OknZqE9j", "Iron Grae", "Terrathrone", "mr ebola man", "ironyuck", "HMS ASSHAT", "Hey Dougie", "therushof it", "Norm Scully", "Iron figar", "wdscrazy99", "yuumers", "Gandalf Rolf", "F 2 P IM", "unlikely mau", "u and i man", "f2p 60c", "ikson", "pieceful one", "Rune 2h sell", "Sylvester910", "f2pspicelord", "hc blvq", "Special Greg", "Dikke b33r", "DLSquirrel", "Fe elession", "Oppai suki", "Ultihardiron", "Laskati", "5ent", "seid", "BlueCap_BC", "Emo HCIM", "f2pMobIron", "Cas F2P", "Rich is Gey", "IM_WikiDic", "Quthalos", "Z3R0 D3ATHS", "Arosial", "BigFootTall", "LingonBerget", "trollare3", "wassaupmaen", "Mo Arabs", "UIM F2P AFK", "Fe2p Clues", "F2P Purki", "ChaoticalF2P", "Artictwo", "kuizg", "Other Sackmo", "HardC FE Man", "Tharadall", "Alxsk911", "Helligegeit", "HC F2P cx", "Buy 1 Pot", "Tru and Blu", "NotBotButAlt", "Burnyoureyes", "Lirithium", "despair trap", "gerben duck", "Rootman89", "oooosonasty", "Dabs R Nice", "Goo Goo", "Zanshi UIM", "Schism22", "2Skeles1Worm", "omega primus", "GlenKayzer", "Leone Wild", "Kiddo Slice", "jiachang", "S K E N G", "Unto Himself", "8copper69", "uim rhys", "Spartan born", "Zeemics", "VAE VlCTlS", "zl00", "earth7", "aMiniMan", "zombobvc", "Oja", "OSAAT in F2P", "Meigryn", "8slayfortgo", "Booksmart", "ivorymage", "Cloud Badass", "jei Kristjan", "jul3ske", "iZbo", "lil maresh", "dbll", "apple zauce", "uim chummy", "akryia", "SatanarchyXX", "UIMBunyan", "HGnostalgia", "Beige Iron", "Ironz 0g", "plzzfreebond", "D3athVsiron", "UwU xP", "ironicated", "Varrock earl", "KISS MY EGO", "gab al ghul", "eyeurnzek", "Shiesty Arch", "One Cute Btw", "friendo btw", "GB Packerz", "woofs f2p", "andi027", "jewgarthe3rd", "wil woody", "Crownaldo", "Sea trout", "latte busch", "F2P BENJY", "UIM SWAI", "Hc freund", "Epitohm BTW", "F2P Bino", "abyss pouch", "rozwala", "Noxpgrind", "Fyerflyer1", "The fixr", "teddyfeaces", "sirreyalisum", "Salty Brad", "Zalnox", "Shmidok", "Draken Feest", "1_null", "daring goat", "Benny Hc Im", "Mobile f2per", "HemeOnc", "um im an uim", "multii3ill", "funny sneed", "LG Brandon", "96thlife", "z zzz zz", "utopiaxd", "f2pKong", "Yamaha ridea", "sharpcow2461", "throwbitsay", "ultipug", "glrdhcim", "charizard IM", "Philly Doc", "uim no pay", "UIM Tmet", "estonian im", "a holy iron", "Raccoon boss", "my torch", "playground g", "xoxo meep", "spookyrake", "vitaminas e", "Harsh25", "basilk1678", "bigironchuby", "third sight", "Hukkawee", "Cosmicflip", "jp skill", "Lee Jobber", "Pemu", "deadoldcat", "2A the Doge", "tom o91", "Chuchulaura", "Iron Wunga", "Lootandboot2", "shiny type", "Exetlai0s", "grunt989172", "jmd992", "pked yo m0m", "Juudanakke", "faustbear", "dave uim", "thesilvervio", "juan10gon", "funky padme", "DewCookies", "Zxnger", "bbrims20", "time sunk", "ctbel", "OWOOOOWWWWW", "clappindash", "m enace", "precious uim", "uiw fyrerose", "HCIM MGS2", "Marthyrr IM", "straccit", "Ehehehez", "F2P toot", "taika rino", "benspotato", "here2chill", "Tiran004", "Griefking23", "Mr Moisted", "S0FAKING GR8", "e z z", "Grim osrs", "lara crooft", "FleeTwoPray", "cristoncmost", "Akikstone717", "Uim elvis", "F2P Law Rune", "Iron Kikyo", "hcim tris", "Puparium", "El Con", "Tukohr", "55zx", "Tuurible", "Masennukseni", "np20", "UIM Kaspur", "Stinky Dane", "fashion rat", "PvP SUCKS HC", "RaianRS", "UIM MrStark", "Earls fat", "jack mama", "don ressler", "fug ddd", "OldSchoolZep", "father pugna", "Lionhaired", "lichtekooi", "Jedwicko", "One plank", "F2P Chin", "Morg", "Doctor Blast", "Sabrinade", "ftp gigachad", "yipne", "Matkapuhelin", "Vulhetaar", "free bontho", "F2P Serdra", "dreary grind", "korskorpi", "Dame Jacinta", "Lord Beeeef", "Uim0b1le", "Gengar ult", "uim edit", "Yugen Zen", "NO LlFER", "Hc just eat", "3rd pk3r99", "1sttryhcim", "Mr Free Iron", "thiefnet", "Tanky monk", "Bettykurps", "Imazuna", "Hard plight", "Nui Harime", "SrJoaum", "dr cbd", "NetWaps", "xArescx", "T erran", "Ironexzenith", "FreestFe", "frog goose", "Fanfare 2", "Lord here", "Sildra 42", "Filthy briq", "Cowedtoohard", "giron timmeh", "joseph torok", "Jern Legende", "Ambar 7", "tequilajess", "Sznitu", "itsMoxMox", "Alkali bee", "jinobu1", "Samgieswag", "ilovepie2007", "F2P Mr Manne", "Berry1908", "eulogybronze", "Ringus man", "Fylke sam", "Ghostricks", "Pekko", "Rhett f2p", "Fichtls lied", "diceminecash", "ui zen", "Maxm076", "kubectl get", "alheli cel", "UDiablo", "F2p im Bored", "theredkoda", "Ult boi", "bjornlarsson", "friar chang", "uim beats", "skyddsfaktor", "all irony", "nolife dead", "bubbl3 b0y", "wolfram f2p", "squirrel216", "The D Bag", "colormefree", "F2p himmel", "PanzerChr1st", "uohhhh seggs", "Letraw", "Glu slu", "W385 viking", "bread1959", "Ask Brandon", "Farm trip", "quest doeser", "Willow Book", "enpogted", "lobben9", "I have boob", "17fluffyfork", "Pompuhharrie", "TEACEANDWAR", "Kitty pspsps", "beefsausages", "Ameeba69", "xxfreegaryxx", "mellomkjott", "FTP clueman", "Skill only", "liver pain", "ju n0", "Thanks Pain", "Notfrozen299", "Mapletonian", "Cooked", "ClueScrolls0", "Jman Here", "Free Chompz", "Hc sand rat", "Sithkegg", "th3 godson", "Limited Sack", "Step Skiller", "F2P Apple", "iEXP slayer", "Sur Lam Nia", "ramen au", "actualhorn", "Feraien", "the shizuka", "RF Scott", "jecan", "lymbicsystem", "FlippinMyDog", "F Byden", "C 02", "b wick", "baldromeo", "kman2iron", "raw dairy", "Maze dweller", "Bluten9471", "7h", "UIM iodiin", "Lillie756"]
