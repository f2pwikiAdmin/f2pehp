class Skill
  ...
  HISCORES_SKILLS = %w[overall attack defence strength hitpoints ranged prayer magic cooking woodcutting p2p fishing firemaking crafting smithing mining p2p p2p p2p p2p p2p runecraft sailing p2p p2p_minigame p2p_minigame p2p_minigame p2p_minigame p2p_minigame p2p_minigame p2p_minigame p2p_minigame lms].freeze
