...
#   3. Excludes F2P bosses (Obor, Bryophyta, and Scurrius) from the check
...
namespace :players do
  desc "Check false_p2p_flagged list for players with P2P boss KC (excluding Obor, Bryophyta, and Scurrius)"
  task check_boss_kc: :environment do
    ...
    # Obor, Bryophyta, and Scurrius are F2P bosses and should be excluded from this check
    P2P_BOSSES = [
    ...
    puts "Obor, Bryophyta, and Scurrius are excluded as they are F2P bosses."
    puts ""
