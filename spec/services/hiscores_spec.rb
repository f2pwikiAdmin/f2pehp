    ...
    context 'with valid CSV data' do
      it 'parses F2P player stats correctly' do
        ...
        csv_data = [
          ...
          '-1,0',                  # Bounty Hunter - Hunter (index 0)
          '-1,0',                  # Bounty Hunter - Rogue (index 1)
          '-1,0',                  # Bounty Hunter (Legacy) - Hunter (index 2)
          '-1,0',                  # Bounty Hunter (Legacy) - Rogue (index 3)
          '5000,50',               # Clue Scrolls (all) (index 4)
          ...
          '-1,0',                  # Artio
          '-1,0',                  # Barrows Chests
          '204782,41',             # Brutus (index 23 - F2P boss)
          ...
          '-1,0',                  # Lunar Chests
          '-1,0',                  # Mad Angel (index 51)
          '-1,0',                  # Maggot King
          '-1,0',                  # Mimic
          '-1,0',                  # Nex
          '-1,0',                  # Nightmare
          '-1,0',                  # Phosani's Nightmare
          '2000,10',               # Obor (index 57 - F2P boss)
          '-1,0',                  # Phantom Muspah
          '-1,0',                  # Sarachnis
          '-1,0',                  # Scorpia
          '-1,0',                  # Scurrius
      ...
      it 'does not flag F2P player as P2P based on P2P activities (mitigation)' do
        ...
        csv_data = [
          ...
          '-1,0',                  # Brutus (F2P boss)
          '2001,8',                # Bryophyta (F2P boss) (index 24)
          '-1,0',                  # Callisto
          '-1,0',                  # Calvar'ion
          '-1,0',                  # Cerberus
          '-1,0',                  # Chambers of Xeric
          ...
          '-1,0',                  # Nightmare
          '-1,0',                  # Phosani's Nightmare
          '2000,10',               # Obor (F2P boss) (index 57)
          '-1,0',                  # Phantom Muspah
          '-1,0',                  # Sarachnis
          '-1,0',                  # Scorpia
          '-1,0',                  # Scurrius
    ...
    context 'CSV parsing' do
      it 'does NOT flag F2P players with PvP Arena rank as P2P' do
        csv_data = [
          ...
          '-1,0',                  # Clue Scrolls (elite) - P2P
          '-1,0',                  # Clue Scrolls (master) - P2P
          '3000,500',              # LMS - Rank (F2P) (index 11)
          '2500,150',              # PvP Arena - Rank (F2P, has rank 150!) (index 12)
          '-1,0',                  # Soul Wars Zeal
          '-1,0',                  # Rifts closed
          '-1,0',                  # Colosseum Glory
          '1000,250',              # Collections Logged (F2P, has 250 collection log!) (index 16)
        ].join("\n")
